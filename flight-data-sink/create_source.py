...
if __name__ == "__main__":
    ...
    if RUNTIME_ENV != "docker":
        ...
        jar_files = ["flink-sql-connector-kafka-3.0.2-1.18.jar"]
        jar_paths = tuple(
        ...
        # env.add_python_file(f"file://{os.path.join(CURRENT_DIR, 'utils.py')}")
        # env.add_python_file(f"file://{os.path.join(CURRENT_DIR, 'models.py')}")
